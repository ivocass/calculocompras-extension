...
var Currency = function(id){
    ...
    this.setCurrentVal = function(val){
        ...
        switch(id){
            ...
            case 'USD':
            app.data.currencyUSDVal = currentVal;
            break;

            case 'EUR':
            app.data.currencyEURVal = currentVal;
            break;

            case 'GBP':
            app.data.currencyGBPVal = currentVal;
            break;
        }
    }
    ...
    this.setAutoMode = function (usesCustomVal){
        ...
        switch(id){
            ...
            case 'USD':
            app.data.isCurrencyUSDCustom = usesCustomVal;    
            break;        

            case 'EUR':
            app.data.isCurrencyEURCustom = usesCustomVal;
            break;

            case 'GBP':
            app.data.isCurrencyGBPCustom = usesCustomVal;
            break;
        }
    ...
    function setLastUpdateDate(date){
        ...
        switch(id){
            case 'USD':
            app.data.currencyUSDLastUpdateDate = lastUpdateDate;
            app.data.currencyUSDLastUpdateDateReadable = self.getLastUpdateDateReadable();
            break;
            
            case 'EUR':
            app.data.currencyEURLastUpdateDate = lastUpdateDate;
            app.data.currencyEURLastUpdateDateReadable = self.getLastUpdateDateReadable();
            break;

            case 'GBP':
            app.data.currencyGBPLastUpdateDate = lastUpdateDate;
            app.data.currencyGBPLastUpdateDateReadable = self.getLastUpdateDateReadable();
            break;
        }
    }
    ...
    this.load = function(index){
        ...
        // update here because of Vue CSP
        this.setAutoMode(_usesCustomVal);
