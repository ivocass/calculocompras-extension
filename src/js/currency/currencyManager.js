...
var CurrencyManager = function(){
    ...
    function init(){
        ...
        app.data.currencies.push(app.data.currencyUSD, app.data.currencyEUR, app.data.currencyGBP); // don't include ARS
    ...
    function onCurrencySliderToggled(data){
        ...
        console.log('onCurrencySliderToggled()', data);
    ...
    this.getCurrencyById = getCurrencyById;
